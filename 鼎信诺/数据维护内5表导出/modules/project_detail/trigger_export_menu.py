...
WINDOW_TITLE_RE = ".*核算项目明细表.*"
WINDOW_CLASS_NAME = "FNWND3105"
WINDOW_LABEL = "project detail"
...
def find_project_detail_window():
...
def trigger_export_menu():
    data_window = find_project_detail_window()
...
if __name__ == "__main__":
    export_filename = export_project_detail()
    print("Export filename:", export_filename)
