...
WINDOW_TITLE_RE = ".*科目余额表.*"
WINDOW_CLASS_NAME = "FNWND3105"
WINDOW_LABEL = "subject balance"
...
def trigger_export_menu():
    data_window = find_subject_window()
...
if __name__ == "__main__":
    export_filename = export_subject_balance()
    print("Export filename:", export_filename)
