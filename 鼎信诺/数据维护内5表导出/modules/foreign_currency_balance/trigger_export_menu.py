...
WINDOW_TITLE_RE = ".*外币余额表.*"
WINDOW_CLASS_NAME = "FNWND3105"
WINDOW_LABEL = "foreign currency balance"
...
def find_foreign_currency_window():
...
def trigger_export_menu():
    data_window = find_foreign_currency_window()
...
def export_foreign_currency_balance():
...
if __name__ == "__main__":
    export_filename = export_foreign_currency_balance()
    print("Export filename:", export_filename)
