...
WINDOW_TITLE_RE = ".*核算项目余额表.*"
WINDOW_CLASS_NAME = "FNWND3105"
WINDOW_LABEL = "project balance"
...
def find_project_balance_window():
...
def trigger_export_menu():
    data_window = find_project_balance_window()
...
if __name__ == "__main__":
    export_filename = export_project_balance()
    print("Export filename:", export_filename)
